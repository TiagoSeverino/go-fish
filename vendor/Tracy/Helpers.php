...
class Helpers
{
	...
	public static function errorTypeToString($type)
	{
		$types = [
			E_ERROR => 'Fatal Error',
			E_USER_ERROR => 'Utilizadores Error',
			...
			E_USER_WARNING => 'Utilizadores Warning',
			E_NOTICE => 'Notice',
			E_USER_NOTICE => 'Utilizadores Notice',
			E_STRICT => 'Strict standards',
			E_DEPRECATED => 'Deprecated',
			E_USER_DEPRECATED => 'Utilizadores Deprecated',
		];
	...
	public static function improveException($e)
	{
		...
		if (!$e instanceof \Error && !$e instanceof \ErrorException) {
			...
			$funcs = array_merge(get_defined_functions()['internal'], get_defined_functions()['Utilizadores']);
